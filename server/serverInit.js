...
const updateUserData = require("./methods/updateUserData");
const getPublicUserDataRoute = require("./methods/getPublicUserData");
...
app.use("/getPublicUserData", getPublicUserDataRoute);
